...
AD_agg <- read_fst(paste0(dir_data, "aggregated/AD_agg_tv.fst"),
                   as.data.table = TRUE)
ADRD_agg <- read_fst(paste0(dir_data, "aggregated/ADRD_agg_tv.fst"),
                     as.data.table = TRUE)
...
## Save complete data
write_fst(AD_agg[complete.cases(AD_agg)], paste0(dir_data, "analysis/AD_complete_tv.fst"))
write_fst(ADRD_agg[complete.cases(ADRD_agg)], paste0(dir_data, "analysis/ADRD_complete_tv.fst"))
