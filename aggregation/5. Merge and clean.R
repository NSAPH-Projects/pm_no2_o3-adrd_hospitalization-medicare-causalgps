...
AD_agg <- read_fst(paste0(dir_proj, "data/aggregated/AD_agg_age_binned.fst"), as.data.table = TRUE)
ADRD_agg <- read_fst(paste0(dir_proj, "data/aggregated/ADRD_agg_age_binned.fst"), as.data.table = TRUE)
...
AD_agg[complete.cases(AD_agg), .N] # 21,467,418 pre-age-binning; 14,700,622 after age-binning
ADRD_agg[complete.cases(ADRD_agg), .N] # 21,388,893; 14,686,443 after age-binning

## Save complete data
write_fst(AD_agg[complete.cases(AD_agg)], paste0(dir_proj, "data/analysis/AD_complete_age_binned.fst"))
write_fst(ADRD_agg[complete.cases(ADRD_agg)], paste0(dir_proj, "data/analysis/ADRD_complete_age_binned.fst"))
